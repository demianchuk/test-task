...
},{"../components/statisticWidget.vue":30,"../config.js":31,"../vue_custom_validators.js":32,"vue":28,"vue-resource":16,"vue-validator":27}],30:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    methods: {
        getStatisticData: function getStatisticData() {
            ...
            this.$http.get(Routing.generate('api_get_statistic_all_statistics', { userName: this.userName, repoName: this.repoName })).then(function (response) {
        ...
        populateModel: function populateModel(data) {
    ...
    events: {
         ...
         */
        submittedForm: function submittedForm(event) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  var id = "/var/www/example.lc/src/AppBundle/Resources/public/js/vue/components/statisticWidget.vue"
  if (!module.hot.data) {
